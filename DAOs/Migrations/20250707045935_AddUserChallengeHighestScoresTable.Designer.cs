...
namespace DAOs.Migrations
{
    ...
    [Migration("20250707045935_AddUserChallengeHighestScoresTable")]
    partial class AddUserChallengeHighestScoresTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessObjects.Models.Artwork", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BusinessObjects.Models.ArtworkDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BusinessObjects.Models.QuizAttempt", b =>
                {
                    ...
                    b.Property<decimal>("TotalPossibleScore")
                        .HasColumnType("decimal(4,1)")
                        .HasColumnName("total_possible_score");
            ...
            modelBuilder.Entity("Helpers.DTOs.General.ModuleSubModuleCourseIds", b =>
                {
                    b.Property<long?>("CourseId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ModuleSubModuleCourseIds");
                });
            ...
            modelBuilder.Entity("Helpers.DTOs.General.QueryResultBFlat", b =>
                {
                    b.Property<DateTime?>("CompletedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("QueryResultBFlats");
                });

            modelBuilder.Entity("Helpers.DTOs.General.TotalScoreResult", b =>
                {
                    b.Property<decimal>("TotalScore")
                        .HasColumnType("numeric")
                        .HasColumnName("total_score");

                    b.ToTable("TotalScoreResults");
                });

            modelBuilder.Entity("Helpers.DTOs.Module.ModuleCourseHasEnrolledBasicViewDTO", b =>
                {
                    b.Property<long>("CourseId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ModuleCourseHasEnrolledBasicViewDTOs");
                });

            modelBuilder.Entity("Helpers.DTOs.SubModule.SubModuleCourseHasEnrolledBasicViewDTO", b =>
                {
                    b.Property<bool?>("IsCompleted")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("SubModuleCourseHasEnrolledBasicViewDTOs");
                });
            ...
            modelBuilder.Entity("BusinessObjects.Models.ArtworkDetail", b =>
                {
                    b.HasOne("BusinessObjects.Models.Artwork", "Artwork")
                        .WithMany("ArtworkDetails")
